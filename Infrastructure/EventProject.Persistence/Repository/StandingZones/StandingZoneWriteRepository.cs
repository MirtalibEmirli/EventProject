...
public class StandingZoneWriteRepository : WriteRepository<StandingZone>, IStandingZoneWriteRepository
{
    public StandingZoneWriteRepository(AppDbContext context) : base(context)
    {
    }
}
